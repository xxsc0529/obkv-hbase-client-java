...
public final class OHConstants {
    ...
    /**
     * ocenbase hbase model is consist of following columns K hbase row key Q hbase qualifier T
     * hbase timeStamp V hbase value
     */
    public static final String[] ALL_COLUMNS = new String[] {"K", "Q", "T", "V"};
     ...
     */
    public static final String HBASE_HTABLE_POOL_CLEAR_BUFFER_ON_FAIL =
            "hbase.htable.pool.clear.buffer.on.fail";

    /** internal attribute of ohtable pool to optimize write-buffer-size attribute for each table */
    public static final String HBASE_HTABLE_POOL_WRITE_BUFFER_SIZE =
            "hbase.htable.pool.write.buffer.size";

    /** internal attribute of ohtable pool to optimize auto-flush attribute for each table */
    public static final String HBASE_HTABLE_POOL_OPERATION_TIMEOUT =
            "hbase.htable.pool.operation.timeout";
    ...
    public static final String HBASE_CLIENT_OPERATION_EXECUTE_IN_POOL =
            "hbase.client.operation.executeinpool";

    public static final String HBASE_HTABLE_THREAD_KEEP_ALIVE_TIME =
    ...
    public static final String HBASE_HTABLE_PUT_WRITE_BUFFER_CHECK =
            "hbase.htable.put.write.buffer.check";
