...
public class OHTableHotkeyThrottleTest {
    ...
    public void testThrottle() throws Exception {
        try {
            ...
            for (int i = 0; i < threadNum; ++i) {
                ...
                if (i < threadNum / 4) {
                    worker.init(
                            ...
                            startTime,
                            500,
                            OHTableHotkeyThrottleUtil.TestType.random,
                            OHTableHotkeyThrottleUtil.OperationType.put,
                            "test",
                            "familyThrottle",
                            null,
                            "Column",
                    ...
                    worker.init(
                            ...
                            500,
                            OHTableHotkeyThrottleUtil.TestType.random,
                            OHTableHotkeyThrottleUtil.OperationType.get,
                            "test",
                            "familyThrottle",
                            null,
                            "Column",
                    ...
                    worker.init(
                            ...
                            500,
                            OHTableHotkeyThrottleUtil.TestType.random,
                            OHTableHotkeyThrottleUtil.OperationType.scan,
                            "test",
                            "familyThrottle",
                            null,
                            "Column",
                    ...
                    worker.init(
                            ...
                            startTime,
                            500,
                            OHTableHotkeyThrottleUtil.TestType.specifiedKey,
                            OHTableHotkeyThrottleUtil.OperationType.put,
                            "test",
                            "familyThrottle",
                            key,
            ...
            // for each 2s, get unitOperationTimes and unitOperationTimes from
            // ObTableHotkeyThrottleUtil and print
            for (int i = 0; i < 20; ++i) {
                Thread.sleep(2000);
