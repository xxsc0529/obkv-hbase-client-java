...
public abstract class HTableTestBase {
        ...
        try {
            ...
            for (Result result : scanner) {
                ...
                for (KeyValue keyValue : result.raw()) {
                    ...
                    Assert.assertTrue(
                            column1.equals(Bytes.toString(keyValue.getQualifier()))
    ...
    public void testGetFilter() throws Exception {
        ...
        ValueFilter valueFilter =
                new ValueFilter(
                        CompareFilter.CompareOp.EQUAL, new BinaryComparator(toBytes(value2)));
        ...
        valueFilter =
                new ValueFilter(
                        CompareFilter.CompareOp.EQUAL, new BinaryComparator(toBytes(value1)));
        get.setFilter(valueFilter);
        r = hTable.get(get);
        Assert.assertEquals(2, r.raw().length);
        ...
        valueFilter =
                new ValueFilter(
                        CompareFilter.CompareOp.GREATER, new BinaryComparator(toBytes(value1)));
        get.setFilter(valueFilter);
        r = hTable.get(get);
        Assert.assertEquals(2, r.raw().length);
        ...
        valueFilter =
                new ValueFilter(
                        CompareFilter.CompareOp.GREATER, new BinaryComparator(toBytes(value3)));
        get.setFilter(valueFilter);
        r = hTable.get(get);
        Assert.assertEquals(0, r.raw().length);
        ...
        QualifierFilter qualifierFilter =
                new QualifierFilter(
                        CompareFilter.CompareOp.EQUAL, new BinaryComparator(toBytes(column1)));
        ...
        qualifierFilter =
                new QualifierFilter(
                        CompareFilter.CompareOp.EQUAL, new BinaryComparator(toBytes(column2)));
        get.setFilter(qualifierFilter);
        r = hTable.get(get);
        Assert.assertEquals(4, r.raw().length);
        ...
        qualifierFilter =
                new QualifierFilter(
                        CompareFilter.CompareOp.GREATER, new BinaryComparator(toBytes(column1)));
        get.setFilter(qualifierFilter);
        r = hTable.get(get);
        Assert.assertEquals(4, r.raw().length);
        ...
        filterList.addFilter(
                new QualifierFilter(
                        CompareFilter.CompareOp.GREATER, new BinaryComparator(toBytes(column2))));
        get = new Get(toBytes(key1));
        get.setMaxVersions(10);
        get.addFamily(toBytes(family));
        get.setFilter(filterList);
        ...
        valueFilter =
                new ValueFilter(
                        CompareFilter.CompareOp.NOT_EQUAL, new BinaryComparator(toBytes(value2)));
    ...
    public void testScan() throws Exception {
        ...
        // scan with HConstants.EMPTY_START_ROW / HConstants.EMPTY_END_ROW /
    ...
    public void testDeleteIllegal() throws IOException {
        try {
            ...
            delete.deleteColumns(
                    "family1".getBytes(), "column1_1".getBytes(), System.currentTimeMillis());
            hTable.delete(delete);
            fail();
        } catch (Exception e) {
    ...
    public void testCheckAndMutationIllegal() throws IOException {
        ...
        try {
            ...
            Assert.assertTrue(
                    e.getCause().getMessage().contains("mutation row is not equal check row"));
        }
    ...
    public void testIncrement() throws IOException {
        ...
        long ret =
                hTable.incrementColumnValue(
                        key.getBytes(), "family1".getBytes(), column.getBytes(), 1);
        Assert.assertEquals(3, ret);
        ret =
                hTable.incrementColumnValue(
                        key.getBytes(), "family1".getBytes(), column.getBytes(), 1, true);
    ...
    public void testQualifyNull() throws Exception {
        ...
        hTable.checkAndPut(
                Bytes.toBytes(key), Bytes.toBytes(family), null, Bytes.toBytes(value), put);
    ...
    public void testPutColumnFamilyNotExists() throws Exception {
        ...
        put4.add(
                "family_not_exists".getBytes(),
                "column2".getBytes(),
                System.currentTimeMillis() - 1000 * 60 * 60L,
                "now - 1h".getBytes());
    ...
    public void testColumnQualifier() throws Exception {
        ...
        Assert.assertArrayEquals(
                "", "value1_qualifier_null".getBytes(), result.raw()[0].getValue());
        ...
        Assert.assertEquals("", 0, result.raw()[0].getQualifierLength());
        Assert.assertArrayEquals(
                "", "value1_qualifier_empty".getBytes(), result.raw()[0].getValue());
        ...
        Assert.assertEquals("", 1, result.raw().length);
        Assert.assertArrayEquals(
                "", "value1_qualifier_space".getBytes(), result.raw()[0].getValue());
        // 空格可以做qualifier
    ...
    public void testTTLColumnLevel() throws Exception {
        ...
        Assert.assertEquals(
                "", 1, result.getColumn("family_ttl".getBytes(), ("column1").getBytes()).size());
        Assert.assertEquals(
                "", 1, result.getColumn("family_ttl".getBytes(), ("column2").getBytes()).size());
        Assert.assertArrayEquals(
                "",
                "column1_value1_ttl_column".getBytes(),
                result.getColumn("family_ttl".getBytes(), ("column1").getBytes())
                        .get(0)
                        .getValue());
        Assert.assertArrayEquals(
                "",
                "column2_value1_ttl_column".getBytes(),
                result.getColumn("family_ttl".getBytes(), ("column2").getBytes())
                        .get(0)
                        .getValue());
